...
PrimeFaces.widget.Apollo = PrimeFaces.widget.BaseWidget.extend({
    ...
    setInlineProfileState: function(expanded) {
        if(expanded)
            $.cookie('apollo_inlineprofile_expanded', "1", {path: '/'});
        else
            $.removeCookie('apollo_inlineprofile_expanded', {path: '/'});
    },
    ...
    restoreMenuState: function() {
        ...
        var inlineProfileCookie = $.cookie('apollo_inlineprofile_expanded');
    ...
    _initRightSidebar: function() {
        ...
        this.rightSidebarBtnOpen.off('click.rightsidebar').on('click.rightsidebar', function(e) {
            $this.rightSidebar.addClass('right-sidebar-active');
            e.preventDefault();
        });
        
        this.rightSidebarBtnClose.off('click.rightsidebar').on('click.rightsidebar', function(e) {
            $this.rightSidebar.removeClass('right-sidebar-active');
            e.preventDefault();
        });
        
        this.rightSidebar.off('click.rightsidebar').on('click.rightsidebar', function() {
            setTimeout(function() {
